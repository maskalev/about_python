...
включают *Python* в той или иной форме. Конечно, мы по-прежнему хотели бы знать о любом коммерческом использовании *Python*.
...
В феврале 1991 года, после чуть более года разработки, я решил опубликовать сообщение в *USENET*. Остальное находится в файле `Misc/HISTORY`. 

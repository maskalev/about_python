...
Чтобы найти информацию для начинающих программистов на *Python*, включая списки руководств, обратитесь 
...
серверов с использованием языка программирования *Python*»](https://ir.cwi.nl/pub/18204), 

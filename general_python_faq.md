...
[groups.google.com](https://groups.google.com/search?q=comp.lang.python&inOrg=false).Так же можно подписаться на рассылку новостей
...
Вы также можете получить доступ к версии *Python* для разработки через *Git*. Подробности в [Руководстве разработчика *Python*](https://devguide.python.org/).

...
[Как указать и обеспечить соблюдение спецификации интерфейса в 
*Python*?](#как-указать-и-обеспечить-соблюдение-спецификации-интерфейса-в-python)
...
Однако основное преимущество конструкции `with` и подобных -- уменьшение 
